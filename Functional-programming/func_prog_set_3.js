...
// // Your code here
const filterStudentsByGrade = (students, givenGrade) => students.filter(({ grade }) => grade > givenGrade);
...
// // Your code here
const filterByGenre = (games, givenGenre) => games.filter(({ genre }) => genre === givenGenre)
...
// // Your code here
const getTitlesWithMoreThan500Pages = books => books.filter(({ pageCount }) => pageCount > 700).map(({ title }) => title);
...
// // Your code here
const getAverageScore = students => students.reduce((sum, curr) => sum + curr.score, 0) / students.length;
...
// // Your code here
const getTotalCost = products => products.reduce((totalCost, curr) => totalCost + curr.price * curr.quantity, 0)
...
// // Your code here
const getMinimumNumber = numbers => numbers.reduce((acc, curr) => acc > curr ? curr : acc, numbers[0])
